  ...
  return (
    <div>
      <div className='md:w-[221px] w-[200px] md:h-[408px] h-[320px] group'>
        ...
        <Image alt="popular movies" src={`${BASE_IMG_URL}${result.poster_path}`} width={190} height={231} className='rounded-md transform group-hover:scale-105 duration-300 overflow-hidden' />
